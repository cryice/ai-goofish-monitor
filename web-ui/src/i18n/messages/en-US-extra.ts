const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      executionModePlaceholder: 'Select an execution mode',
      periodicMode: 'Periodic (Cron)',
      continuousMode: 'Continuous Crawl',
      executionModes: {
        periodic: 'Periodic (Cron)',
        continuous: 'Continuous Crawl',
      },
      batchPages: 'Pages Per Batch',
      sleepInterval: 'Sleep Interval',
      sleepIntervalMin: 'Min',
      sleepIntervalMax: 'Max',
      sleepIntervalUnit: 'seconds',
      maxPageLimit: 'Max Page Limit',
      schedule: 'Schedule',
