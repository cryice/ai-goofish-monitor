...
const enUS = {
  ...
  taskProgress: {
    ...
    title: 'Task Progress',
    description: 'Track live connection state, current page, processed items, and recent progress history for each task.',
    taskList: 'Task List',
    runningCount: '{count} running',
    noTaskSelected: 'Select a task to view progress',
    noHistory: 'No progress history yet',
    history: 'Recent Progress History',
  ...
  results: {
    ...
    card: {
      ...
      block: 'Block',
      unblock: 'Unblock',
      viewSkuOptions: 'View SKU Options ({count})',
    },
  },
  logs: {
    title: 'Logs',
  ...
  collectedData: {
    title: 'Collected Data View',
    description: 'View all collected product data without navigating to the original pages to browse details.',
    noData: 'No collected data yet',
    viewOriginal: 'View Original Page',
    copyLink: 'Copy Link',
    filters: {
      keyword: 'Keyword',
      keywordPlaceholder: 'Enter keyword to filter...',
