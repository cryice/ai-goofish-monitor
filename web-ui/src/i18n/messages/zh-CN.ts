...
const zhCN = {
  ...
  taskProgress: {
    kicker: '执行状态',
    title: '任务执行进度',
    description: '查看每个任务的实时连接状态、当前页码、商品处理数量和最近进度历史。',
    taskList: '任务列表',
    runningCount: '运行中 {count} 个',
    noTaskSelected: '请选择一个任务查看进度',
    noHistory: '暂无进度历史',
    history: '最近进度历史',
    historyPage: '第 {page} 页',
    remaining: '剩余 {count}',
    lastError: '最近错误',
    completed: '已完成',
    waiting: '等待中',
  ...
  collectedData: {
    title: '采集数据查看',
    description: '查看所有已采集的商品数据，无需跳转到原始页面即可浏览详细信息。',
    noData: '暂无采集数据',
    viewOriginal: '查看原网页',
    copyLink: '复制链接',
    filters: {
      keyword: '关键词',
      keywordPlaceholder: '输入关键词过滤...',
      status: 'AI分析状态',
      category: '商品分类',
      all: '全部',
      recommended: '推荐',
